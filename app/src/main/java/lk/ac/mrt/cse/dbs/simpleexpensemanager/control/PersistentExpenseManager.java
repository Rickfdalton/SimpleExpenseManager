...
public class PersistentExpenseManager extends ExpenseManager {
    ...
    public void setup() {
        ...
        TransactionDAO PersistentMemoryTransactionDAO = new PersistentMemoryTransactionDAO(dh);
        setTransactionsDAO(PersistentMemoryTransactionDAO);

        AccountDAO PersistentMemoryAccountDAO = new PersistentMemoryAccountDAO(dh);
